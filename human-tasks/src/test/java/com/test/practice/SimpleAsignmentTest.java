 ...
 * 
 */
public class SimpleAsignmentTest extends BaseHumanTaskTest {
	...
	protected String[] getProcessPaths() {
		return new String[] { "com/test/practice/01-simple-asignment.bpmn" };
	}
	...
	private void fullCycleCompleteTask(long taskId, String userId,
		...
		// client.claim(taskId, userId, groups); CLAIM NOT NEEDED, AS demian IS
		// THE ONLY POTENTIAL OWNER, IT IS CLAIMED AUTOMATICALLY
